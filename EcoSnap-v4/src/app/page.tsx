              ...
              <Dialog key={`top-${category.id}`} open={isUploadModalOpen && currentUploadCategory === category.id && currentUploadCategoryFriendlyName === category.name} onOpenChange={ open => {
                ...
                <DialogTrigger asChild>
                  <Card
                    ...
                    className="p-2 sm:p-2 md:p-4 flex flex-col items-center gap-1.5 sm:gap-1.5 md:gap-3 cursor-pointer hover:bg-muted/50 transition-colors shadow-sm w-[85px] sm:w-[100px] md:w-[160px] flex-shrink-0"
                  >
                     <ImageWithFallback
                        ...
                        sizes="(max-width: 639px) 40px, (max-width: 767px) 48px, 96px"
                        wrapperClassName="relative w-10 h-10 sm:w-12 sm:h-12 md:w-24 md:h-24 rounded-md overflow-hidden bg-muted flex-shrink-0 flex items-center justify-center"
